...
export function lanzarModalMemory(ganador) {
  ...
  if (ganador == "Jugador 1") {
    let partidasGanadasMemoryJugador1 = parseInt(localStorage.getItem("partidasGanadasMemoryJugador1a"), 10) || 0;
    partidasGanadasMemoryJugador1++;
    localStorage.setItem("ultimoGanadorMemory", "Jugador 1");
    localStorage.setItem("partidasGanadasMemoryJugador1a", partidasGanadasMemoryJugador1.toString());
  ...
  if (ganador == "Jugador 2") {
    let partidasGanadasMemoryJugador2 = parseInt(localStorage.getItem("partidasGanadasMemoryJugador2a"), 10) || 0;
    partidasGanadasMemoryJugador2++;
    localStorage.setItem("ultimoGanadorMemory", "Jugador 2");
    localStorage.setItem("partidasGanadasMemoryJugador2a", partidasGanadasMemoryJugador2.toString());
